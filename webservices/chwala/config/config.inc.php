...
$config['plugins'] = array(
    'archive',
    'zipdownload',
  'calendar' , 'kolab_auth',  'kolab_activesync' ,'kolab_addressbook' , 'kolab_config'  , 'ldap_authentication' , 'kolab_folders' , 'kolab_files' ,  'libcalendaring' , 
...
$rcmail_config['ldap_public']['GAL'] = array(
  ...
  'search_filter'  => '(&(mail=*4data.ro))',   // e.g. '(&(objectClass=posixAccount)(uid=%u))'
  ...
  'filter'        => '(&(objectClass=inetOrgPerson)(mail=*%d))',      // used for basic listing (if not empty) and will be &'d with search queries. example: status=act
