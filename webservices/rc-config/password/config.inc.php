...
$rcmail_config['password_ldap_basedn'] = 'dc=machinet';
...
$rcmail_config['password_ldap_search_base'] = 'dc=machinet';
...
$rcmail_config['password_ldap_search_filter'] = '(&(objectclass=mailaccount)(uid=%login))';
