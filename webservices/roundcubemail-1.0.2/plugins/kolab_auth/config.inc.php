...
//---------------------------------------------------------------------
$rcmail_config['kolab_auth_addressbook'] = 'GAL';

// This will overwrite defined filter
$rcmail_config['kolab_auth_filter'] = '(&(objectClass=InetOrgPerson)(uid=%fu))';

// Use this fields (from fieldmap configuration) to get authentication ID
$rcmail_config['kolab_auth_login'] = 'uid';
...
$rcmail_config['kolab_auth_email']        = array('mail');
...
$rcmail_config['kolab_auth_ldap_addressbooks'] = array('GAL');
