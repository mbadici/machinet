...
$config['password_ldap_basedn'] = 'dc=machinet';
...
//$config['password_ldap_userDN_mask'] = 'uid=%login,ou=users,dc=machinet';
...
//$config['password_ldap_searchDN'] = 'ou=users,dc=machinet';
